...
<!--  -->
        ...
        <text class="month-name" style="font-size: 10px" :x="15 * 7" y="10">
          November
        </text>
        <text class="month-name" style="font-size: 10px" :x="15 * 12" y="10">
          December
        </text>
        <text class="month-name" style="font-size: 10px" :x="15 * 17" y="10">
          January
        </text>
        <text class="month-name" style="font-size: 10px" :x="15 * 23" y="10">
          February
        </text>
        <text class="month-name" style="font-size: 10px" :x="15 * 28" y="10">
          March
        </text>
        <text class="month-name" style="font-size: 10px" :x="15 * 33" y="10">
          April
        </text>
        <text class="month-name" style="font-size: 10px" :x="15 * 39" y="10">
          May
        </text>
        <text class="month-name" style="font-size: 10px" :x="15 * 44" y="10">
          June
        </text>
        <text class="month-name" style="font-size: 10px" :x="15 * 49" y="10">
          July
        </text>
        <text class="month-name" style="font-size: 10px" :x="15 * 55" y="10">
          August
        </text>
        <text class="month-name" style="font-size: 10px" :x="15 * 60" y="10">
          September
        </text>
        <text
          class="day-initial"
